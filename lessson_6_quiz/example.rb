...
File.write(
  ...
  mode: 'a' # открыть файл только для записи и дописывать контент в КОНЕЦ ФАЙЛА!!! - это режимы работа с файлами
)
...
all_questions.shuffle.each do |question_data|
  ...
  # создается переменная чтобы она работала и в цикле и вне!!
